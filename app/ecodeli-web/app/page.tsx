      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-48">
          <div className="text-center">
            ...
            <h1 className="text-5xl font-semibold tracking-tight text-[#49cb5c] sm:text-5xl">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <a
                href="#"
                className="rounded-md bg-[#49cb5c] px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-[#07b128] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#09a66d]"
              >
                Commencer
              </a>
              <a href="#" className="text-sm font-semibold text-gray-900">
