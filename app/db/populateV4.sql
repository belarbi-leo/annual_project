...
------------------------------
INSERT INTO "languages" (langue,iso) VALUES
  ('Français','FR'),
  ('Anglais','EN'),
  ('Espagnol','ES'),
  ('Allemand','DE'),
...
------------------------------
INSERT INTO "users" (date_registration, date_acceptCGU, role, account_status, date_status, email, password, phone_number, first_name, last_name, company_name, siret, bio, id_subscription, id_langue) VALUES
  ('2025-01-01 09:00:00', '2025-01-01 08:59:50', 'admin', 'active', '2025-01-01 09:00:00', 'admin@example.com', 'password0000', 0612345678, 'Alice', 'Dupont', NULL, NULL, NULL, 1, 1),
  ('2025-01-01 09:00:00', '2025-01-01 08:59:50', 'admin', 'active', '2025-01-01 09:00:00', 'admin@example.com', 'password0000', 0612345678, 'David', 'Lefevre', NULL, NULL, NULL, 1, 1),
  ('2025-01-01 09:00:00', '2025-01-01 08:59:50', 'part', 'active', '2025-01-01 09:00:00', 'part@example.com', 'password0000', 0612345678, 'Bob', 'Martin', NULL, NULL, 'Juste un gars chill, qui veux payer plus chère ses livraisons', 1, 1),
  ('2025-01-01 09:00:00', '2025-01-01 08:59:50', 'part', 'active', '2025-01-01 09:00:00', 'part@example.com', 'password0000', 0612345678, 'Emma', 'Moreau', NULL, NULL, 'Juste un gars chill, qui veux payer plus chère ses livraisons', 1, 1),
  ('2025-01-01 09:00:00', '2025-01-01 08:59:50', 'part', 'active', '2025-01-01 09:00:00', 'part@example.com', 'password0000', 0612345678, 'Bob', 'Martin', NULL, NULL, 'Juste un gars chill, qui veux payer plus chère ses livraisons', 2, 1),
  ('2025-01-01 09:00:00', '2025-01-01 08:59:50', 'part', 'overlays', '2025-01-01 09:00:00', 'part@example.com', 'password0000', 0612345678, 'Bob', 'Martin', NULL, NULL, 'Juste un gars chill, qui veux payer plus chère ses livraisons', 2, 1),
  ('2025-01-01 09:00:00', '2025-01-01 08:59:50', 'part', 'banned', '2025-01-02 09:00:00', 'part@example.com', 'password0000', 0612345678, 'Bob', 'Martin', NULL, NULL, 'Juste un gars chill, qui veux payer plus chère ses livraisons', 2, 1),
  ('2025-01-01 09:00:00', '2025-01-01 08:59:50', 'pro', 'active', '2025-01-02 09:00:00', 'pro@example.com', 'password0000', 0612345678, NULL, NULL, 'ProServices', 10000000000003, 'Juste pour parler de notre entreprise, on est les meilleurs, pas de débat', 1, 1),
  ('2025-01-01 09:00:00', '2025-01-01 08:59:50', 'pro', 'active', '2025-01-02 09:00:00', 'pro@example.com', 'password0000', 0612345678, NULL, NULL, 'EnzoServices', 10000000000003, 'Juste pour parler de notre entreprise, on est les meilleurs, pas de débat', 3, 1),
  ('2025-01-01 09:00:00', '2025-01-01 08:59:50', 'pro', 'active', '2025-01-02 09:00:00', 'pro@example.com', 'password0000', 0612345678, NULL, NULL, 'BryanServices', 10000000000003, 'Juste pour parler de notre entreprise, on est les meilleurs, pas de débat', 1, 1);
  ('2025-01-01 09:00:00', '2025-01-01 08:59:50', 'pro', 'pro_pending', '2025-01-01 09:00:00', 'pro@example.com', 'password0000', 0612345678, NULL, NULL, 'Lesmeilleursdelaplace', 10000000000003, 'Juste pour parler de notre entreprise, on est les meilleurs, pas de débat', 1, 1),
  ('2025-01-01 09:00:00', '2025-01-01 08:59:50', 'pro', 'pro_pending', '2025-01-01 09:00:00', 'pro@example.com', 'password0000', 0612345678, NULL, NULL, 'ESGI_Services', 10000000000003, 'Juste pour parler de notre entreprise, on est les meilleurs, pas de débat', 3, 1),
  ('2025-01-01 09:00:00', '2025-01-01 08:59:50', 'pro', 'overlays', '2025-01-02 09:00:00', 'pro@example.com', 'password0000', 0612345678, NULL, NULL, 'Léo-Services', 10000000000003, 'Juste pour parler de notre entreprise, on est les meilleurs, pas de débat', 1, 1);
...
INSERT INTO "requests_services" (id_user_req, id_admin_res, id_service, status_req, date_req, date_res, reason_res) VALUES
  ...
  (11, 1, 6, 'pending', '2025-01-01 09:00:00', NULL, NULL),
  (12, 1, 9, 'pending', '2025-01-01 09:00:00', NULL, NULL),
  ...
  (8, 1, 6, 'pending', '2025-01-02 09:00:00', NULL, NULL),
  (9, 1, 9, 'pending', '2025-01-02 09:00:00', NULL, NULL),
  (10, 1, 6, 'pending', '2025-01-02 09:00:00', NULL, NULL),
