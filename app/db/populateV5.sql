...
INSERT INTO "users" (date_registration, date_accept_cgu, role, account_status, date_status, email, password, phone_number, first_name, last_name, company_name, siret, bio, id_subscription, id_language) VALUES
  ...
  ('2025-01-01 09:00:00', '2025-01-01 08:59:50', 'part', 'active', '2025-01-01 09:00:00', 'part1@example.com', 'password0000', '0612345678', 'Bob', 'Martin', NULL, NULL, 'Juste un gars chill, qui veux payer plus chère ses livraisons', 1, 1),
  ('2025-01-01 09:00:00', '2025-01-01 08:59:50', 'part', 'active', '2025-01-01 09:00:00', 'part2@example.com', 'password0000', '0612345678', 'Emma', 'Moreau', NULL, NULL, 'Juste un gars chill, qui veux payer plus chère ses livraisons', 1, 1),
  ('2025-01-01 09:00:00', '2025-01-01 08:59:50', 'part', 'active', '2025-01-01 09:00:00', 'part3@example.com', 'password0000', '0612345678', 'Bob', 'Martin', NULL, NULL, 'Juste un gars chill, qui veux payer plus chère ses livraisons', 2, 1),
  ('2025-01-01 09:00:00', '2025-01-01 08:59:50', 'part', 'overlays', '2025-01-01 09:00:00', 'part4@example.com', 'password0000', '0612345678', 'Bob', 'Martin', NULL, NULL, 'Juste un gars chill, qui veux payer plus chère ses livraisons', 2, 1),
  ('2025-01-01 09:00:00', '2025-01-01 08:59:50', 'part', 'banned', '2025-01-02 09:00:00', 'part5@example.com', 'password0000', '0612345678', 'Bob', 'Martin', NULL, NULL, 'Juste un gars chill, qui veux payer plus chère ses livraisons', 2, 1),
  ('2025-01-01 09:00:00', '2025-01-01 08:59:50', 'pro', 'active', '2025-01-02 09:00:00', 'pro1@example.com', 'password0000', '0612345678', NULL, NULL, 'ProServices', '10000000000003', 'Juste pour parler de notre entreprise, on est les meilleurs, pas de débat', 1, 1),
  ('2025-01-01 09:00:00', '2025-01-01 08:59:50', 'pro', 'active', '2025-01-02 09:00:00', 'pro2@example.com', 'password0000', '0612345678', NULL, NULL, 'EnzoServices', '10000000000003', 'Juste pour parler de notre entreprise, on est les meilleurs, pas de débat', 3, 1),
  ('2025-01-01 09:00:00', '2025-01-01 08:59:50', 'pro', 'active', '2025-01-02 09:00:00', 'pro3@example.com', 'password0000', '0612345678', NULL, NULL, 'BryanServices', '10000000000003', 'Juste pour parler de notre entreprise, on est les meilleurs, pas de débat', 1, 1),
  ('2025-01-01 09:00:00', '2025-01-01 08:59:50', 'pro', 'pro_pending', '2025-01-01 09:00:00', 'pro4@example.com', 'password0000', '0612345678', NULL, NULL, 'Lesmeilleursdelaplace', '10000000000003', 'Juste pour parler de notre entreprise, on est les meilleurs, pas de débat', 1, 1),
