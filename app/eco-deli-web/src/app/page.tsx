        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <a
                href="#"
                className="rounded-md bg-[#09a66d] px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-[#07b128] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#09a66d]"
              >
                Commencer
              </a>
              <a href="#" className="text-sm font-semibold text-gray-900">
