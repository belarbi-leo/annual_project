      ...
      <div className="flex items-center justify-center h-screen px-6 sm:px-16 lg:px-24">
        <div className="text-center">
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row sm:gap-x-6 w-full">
            <Link href="auth" className="w-full sm:w-auto text-center rounded-md bg-[#49cb5c] dark:bg-[#36a84b] px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-[#07b128] dark:hover:bg-[#2e8c40] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#09a66d]">
              Se connecter
            </Link>
            <Link href="public/about" className="w-full sm:w-auto text-center text-sm font-semibold text-gray-900 dark:text-white">
              En savoir plus
            </Link>
          </div>
        </div>
